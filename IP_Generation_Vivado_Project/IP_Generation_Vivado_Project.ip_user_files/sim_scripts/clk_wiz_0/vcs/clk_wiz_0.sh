...
#
# Generated by Vivado on Sun Nov 13 23:26:00 EST 2022
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../IP_Generation_Vivado_Project.gen/sources_1/ip/clk_wiz_0/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../IP_Generation_Vivado_Project.gen/sources_1/ip/clk_wiz_0/clk_wiz_0.v" \
  2>&1 | tee -a vlogan.log
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/oliver/6111_Final_Project/IP_Generation_Vivado_Project/IP_Generation_Vivado_Project.cache/compile_simlib/vcs"
  fi
